...
setup(
    name='openedx-imscc-exporter-ext',
    version=VERSION,
    description="""Common Cartridge 1.x package exporter for multiple courses using Learning Tools Interoperability (LTI) Consumer links for loading Open edX course content.""",
