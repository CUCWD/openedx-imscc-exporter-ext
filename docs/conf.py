...
"""
openedx-imscc-exporter-ext documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-imscc-exporter-ext',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/CUCWD/openedx-imscc-exporter-ext",
...
#
# html_title = 'openedx-imscc-exporter-ext v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Common Cartridge 1.x package exporter for multiple courses using Learning Tools Interoperability (LTI) Consumer links for loading Open edX course content.',
     'Miscellaneous'),
]
